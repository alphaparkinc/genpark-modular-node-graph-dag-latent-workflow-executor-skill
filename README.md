# genpark-modular-node-graph-dag-latent-workflow-executor-skill
...
> **GenPark AI Agent Skill** -- Modular node-graph DAG executor for latent image & video workflows (ComfyUI style)
